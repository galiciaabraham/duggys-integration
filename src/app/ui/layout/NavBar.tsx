    ...
    <nav className="bg-main-1  md:flex-grow">
      ...
      <div className={`items-center justify-between ${isOpen ? 'flex' : 'hidden'} w-full md:flex md:order-1"`}>
        <ul className="flex flex-col md:justify-evenly p-4 md:p-0 mt-4 font-medium  md:text-secondary-1 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-2 md:border-0 w-full text-center">
          <li className=  {`${pathname === "/" ? "active text-main-2 bg-secondary-1 hover:bg-secondary-2 hover:text-secondary-1 md:text-main-2 md:bg-secondary-1 md:hover:bg-secondary-2 md:hover:text-secondary-1"  : "bg-main-1 text-secondary-1 hover:bg-secondary-1 hover:text-main-1 md:shadow-none"} p-2 m-2 rounded-md shadow-md `}>
          ...
          <li className=  {`${pathname === "/menu" ? "active text-main-2 bg-secondary-1 hover:bg-secondary-2 hover:text-secondary-1 md:text-main-2 md:bg-secondary-1 md:hover:bg-secondary-2 md:hover:text-secondary-1"  : "bg-main-1 text-secondary-1 hover:bg-secondary-1 hover:text-main-1 md:shadow-none"} p-2 m-2 rounded-md shadow-md `}>
          ...
          <li className=  {`${pathname === "/about" ? "active text-main-2 bg-secondary-1 hover:bg-secondary-2 hover:text-secondary-1 md:text-main-2 md:bg-secondary-1 md:hover:bg-secondary-2 md:hover:text-secondary-1"  : "bg-main-1 text-secondary-1 hover:bg-secondary-1 hover:text-main-1 md:shadow-none"} p-2 m-2 rounded-md shadow-md `}>
